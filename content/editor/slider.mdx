...
### Multi-Image Field Binding

You can also bind a slider directly to a multi-image CMS field. In the slider settings, switch the content source to **CMS** and select a multi-image field — each image in the field becomes a slide automatically. This is useful for product galleries, portfolio images, or any item with multiple photos.
