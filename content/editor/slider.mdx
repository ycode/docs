...
On the published site, previous, next, and pagination bullets render as `button type="button"` with accessible names. Prev/next announce `Previous slide` and `Next slide`; bullets announce `Go to slide`.
