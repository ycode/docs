...
Each block inside a Rich Text element (heading, paragraph, list, blockquote, image) appears as a sublayer in the Layers panel. You can expand the Rich Text layer to see and select individual blocks.
