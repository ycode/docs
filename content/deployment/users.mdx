...
Self-hosted Ycode supports four roles with different levels of access. Manage users and roles from **Settings → Users** in the builder.

<Callout type="info">
This page covers the self-hosted role model. On [Ycode Cloud](/docs/cloud/teams), team membership is scoped per project (personal workspaces) or workspace-wide (agency workspaces) instead.
</Callout>
