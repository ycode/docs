...
This guide walks you through installing Ycode either on Vercel (recommended for production) or locally for development.
...
Fork the [Ycode repository](https://github.com/niceformal/ycode) on GitHub. This creates a copy under your account that you can deploy.
...
3. Go to **Settings > API** and copy:
   - Project URL (or use it to derive the connection string)
   - `anon` public key
...
```bash
git clone https://github.com/niceformal/ycode.git
cd ycode
```
