...
<Callout type="warning" title="Ycode Legacy is closing on July 1, 2026">
We recommend migrating sooner rather than later so you have plenty of time to review everything before the shutdown. If you run into any issues, reach out to us on [Discord](https://discord.gg/nuGC2JDWqW) — we're happy to help.
</Callout>
