...
This guide walks you through creating your first page in Ycode and using the visual editor.

## Open the Editor

1. Go to your Ycode site (e.g. `https://your-site.vercel.app` or `http://localhost:3002`).
2. Navigate to `/ycode` to open the editor.
3. If you have not run the setup wizard yet, you will be redirected to `/ycode/welcome`. Complete the wizard to create your admin account first.
