...
**Ycode Open Source:** Go to your Ycode site (e.g. `https://your-site.vercel.app` or `http://localhost:3002`) and navigate to `/ycode`. If you have not run the setup wizard yet, you will be redirected to `/ycode/welcome` to connect Supabase, create your admin account, and optionally pick a starter template.
